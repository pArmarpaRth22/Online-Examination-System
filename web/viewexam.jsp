...
table {
  width: 95%;
    ...
    <body>
        ...
        <sql:setDataSource var="db" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/mini_project" user="root" password="parth"/>
                ...
                <tr>
                    ...
                    <td>
                        <form action="deletequestion" method="Post">
                            <input type="hidden" name="questionId" value="${tbl.id}">
                            <input type="hidden" name="sub" value="${examsubject}">
