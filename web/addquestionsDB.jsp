<%-- 
    Document   : addquestionsDB
    Created on : 16-Apr-2024, 12:41:49 am
    Author     : hp
--%>
...
<html>
    ...
    <body>
        <sql:setDataSource driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/mini_project" 
        user="root" password="parth"></sql:setDataSource>
