<%-- 
    ...
    Created on : 16-Apr-2024, 12:39:55 am
    Author     : hp
--%>
              ...
              <div class="container">
                ...
                <p>
                  <select name="examsubject">
                      <option name="ajp" value="AJAVA">AJava</option>
                      <option name="mp" value="MPI">MPI</option>          
<!--                      <option name="toc" value="TOC">TOC</option>          
                      <option name="wp" value="WP">WP</option>          
